   ...
   <div> <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <Link class="nav-link" to='/login' id='navlink'> <i>Login</i></Link>
        </li>
      </ul>
  ...
  {campaign.collected < campaign.amount && (
    <h5 className="card-title text-primary">
      <i>Balance: ₹{campaign.amount - campaign.collected}</i>
        ...
        <button class="btn btn-outline-primary" onClick={handleClick} disabled={campaign.collected >= campaign.amount}><i>Donate</i> <FaDonate /></button><span className='text-success m-2'><b><i>{campaign.collected >= campaign.amount ? 'Completed' : ''}</i></b></span>
      </div>
    </div>
  </div>
</div>
